...
| [`features/http-api-reference.md`](features/http-api-reference.md) | The canonical per-route table (method · auth · purpose) for all 77 routes — candidate/public, admin, evaluation, and invigilator — plus the shared Alert JSON contract. |
