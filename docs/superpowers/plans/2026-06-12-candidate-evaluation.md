...
- Old playbook: `<your-contest-eval-data-dir>/{METHODOLOGY.md,ANGLES.md,ADDITIONAL-ANGLES.md,CONVENTIONS.md}`, scripts (`analyze_meta.py`, `clone_detect.py`, `build_profiles.py`, `build_report.py`, `reconcile.py`), run outputs under `KEC-Aerele-06-26/386632-live/`.
