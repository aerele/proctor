...
Key paths: `<repo>/monitoring/poller.py`, `<repo>/monitoring/alerts.py`, `<repo>/backend/src/handler.mjs` (lines 3305-3424, 4344), `<repo>/monitoring/.data/session.local`, `<repo>/night-run/archive-2026-06-05-sshgate-v12/RESUME-STATE.md` (the KEC run log/runbook).