...
// the engine itself) — never hand-typed. composeSqlExecSource is exported as THE
// single source of truth both the exec handlers and any authoring tooling go
// through, so the pipeline that builds an expected output is byte-identical to
