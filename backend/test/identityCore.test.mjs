...
test("F-D upload warns on a repeated id suffix + separator-heavy column; upload still succeeds", async () => {
  ...
  const rows = [
    { college: "KPR", unique_id: "23cs201_kpriet", name: "Latha", email: "", room: "" },
    { college: "KPR", unique_id: "23cs200_kpriet", name: "Devan", email: "", room: "" },
    { college: "KPR", unique_id: "23am202_KPRIET", name: "Ravi", email: "", room: "" },
    { college: "KPR", unique_id: "sureshk001", name: "Suresh", email: "", room: "" }
  ];
...
test("F-D uniqueIdShapeWarnings (pure): thresholds — suffix needs 3+, separators need 30%", () => {
  ...
  assert.deepEqual(uniqueIdShapeWarnings(["23cs201", "23cs200", "23am202"]), []);
});
